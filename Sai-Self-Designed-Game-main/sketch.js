...
function draw(){
    ...
    if(gameState==="play"){
        ...
        stroke("white")
        strokeWeight(5)
        text("High Score: "+high_score,(camera.x+500),50)
    ...
    if(gameState==="end"){
        ...
        stroke("blue")
        strokeWeight(5)
        text("High Score: " + high_score, camera.x - 150, camera.y + 250)
    ...
    if(gameState === 'lose'){
        ...
        button = createImg("pics/restart.png");
        button.position(camera.x - 150, camera.y + 100);
        button.size(300, 150)
